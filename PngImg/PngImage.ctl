...
Begin VB.UserControl PngImage 
   ...
   PropertyPages   =   "PngImage.ctx":0000
   ScaleHeight     =   72
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   72
   ToolboxBitmap   =   "PngImage.ctx":0015
   Windowless      =   -1  'True
End
Attribute VB_Name = "PngImage"
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    UserControl.BackColor = PropBag.ReadProperty("BackColor", &HFFFFFF)    'myzchh
    With PropBag
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    Dim srcData() As Byte
    Call PropBag.WriteProperty("BackColor", UserControl.BackColor, &HFFFFFF)    'myzchh
    If Not cImage.ImageType = imgCheckerBoard Then
